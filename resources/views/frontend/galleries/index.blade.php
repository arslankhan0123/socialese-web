    ...
    <div class="container">
        <div class="text-center mb-5">
            ...
            <p class="lead text-muted">
                Explore our premium galleries with detailed images.
            </p>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <a href="{{ route('galleries.show', $gallery->id) }}" style="text-decoration:none;">
                    <div class="service-card card">
                        <div class="card-body text-center">
                            ...
                            <div class="p-3">
                                <h4 class="card-title mb-2">{{ $gallery->name }}</h4>
                            </div>
                        </div>
                    </div>
                </a>
